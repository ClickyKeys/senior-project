...
# Uncomment and run to intall the following packages if running this code for the first time
# install.packages("tidyverse", "rlist", "skimr", "caret", "MASS", "cvms", "kableExtra", "VIM", "sjPlot", "factoextra", "NbClust", "cluster", "rgl", "fossil")
...
# IMPORTANT: Uncomment and run if 'data-cleanup.R' was updated and run with new data
# cluster <- read_csv("data/Measures_by_Hospital_Acute_Care_Final.csv")
```
...
# write_csv(cluster_NAR, "data/cluster_normalized_Final.csv")
```
...
cluster_norm <- read_csv("data/cluster_normalized_Final.csv")
